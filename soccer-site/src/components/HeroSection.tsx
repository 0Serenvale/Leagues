      ...
      <div className="flex flex-col md:flex-row p-6 gap-6 items-center">
         ...
         <div className="w-full md:w-2/3 flex flex-col justify-center">
            ...
            <p className="text-gray-600 text-sm leading-relaxed border-l-2 border-gray-300 pl-4">
               Suivez l'événement majeur du championnat. La rencontre tant attendue entre <strong>{homeTeam.name}</strong> et <strong>{awayTeam.name}</strong> s'annonce explosive. Ne manquez pas cette affiche de la journée qui pourrait bouleverser le classement de la ligue de football de wilaya.
            </p>
